...
<body class="bg-[#eee]">
  ...
  <nav class="bg-[#fff] flex flex-col md:flex-row text-[#D4AF37] shadow-md leading-none">
    <div class="flex items-center mx-5 py-5 md:py-0">
      <img src="icon.svg" alt="" width="32px" height="32px">
      <h1 class="text-2xl ml-2 inline-block text-[#1d2e4f]">Cinentica</h1>
    </div>
    <div class="md:flex md:flex-grow">
      <ul class="text-lg md:flex md:ml-auto ">
        <li>
          <a class="w-full md:w-auto p-5 inline-block  border-b-4 border-transparent hover:border-[#D4AF37] hover:bg-[#05173c]"
            href="">Home</a>
        </li>
        <li><a
            class="w-full md:w-auto p-5 inline-block border-b-4 border-transparent hover:border-[#D4AF37] hover:bg-[#05173c]"
            href="">ภาพยนตร์</a></li>
        <li><a
            class="w-full md:w-auto p-5 inline-block border-b-4 border-transparent hover:border-[#D4AF37] hover:bg-[#05173c]"
            href="">โปรโมชั่น</a></li>
  ...
  <div class="">
    <div>
      <ol
        ...
        <li class="relative flex items-center justify-center gap-2 bg-[#2851a5] p-4">
          <span
          ...
          <svg class="h-7 w-7 shrink-0 text-[#eee]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round"
          ...
          <p class="leading-none text-[#eee]">
            <strong class="block font-medium"> เลือกที่นั่งฉาย </strong>
          </p>
        </li>
  ...
  <!-- hero -->
  <section class="text-white body-font overflow-hidden bg-[#030d24]">
        <div class="container grid px-5 py-24 mx-auto justify-items-center">
            <div class="w-full lg:w-6/6 sm:w-6/6 md:5/5 mx-auto flex flex-wrap items-center">
                <img alt="" class="lg:w-[260px] w-[260px] lg:h-[380px] object-center rounded"
                    src="https://lh3.googleusercontent.com/cAyslT3HHEphbvcPqlVr2L_Xeo1orcEheJAyXYWjTQF8TplqPkcDbIynXb2GX9TfJBZTSVLYN-NQN91kO6gOg6iDy6WGph59Tg=w260">
                <div class="lg:w-2/2 md:w-3/6 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    <h2 class="text-sm title-font text-gray-500 tracking-widest">Movie name</h2>
                    <h1 class="text-[#D4AF37] text-3xl title-font font-medium mb-1">ออพเพนไฮเมอร์</h1>
                    <div class="flex mb-2">
                    </div>
                    <div class="flex mb-10">
                        <span class="flex  py-2 space-x-2s text-[#eee]">
                            ...
                            </svg> คณะเทคโนโลยีสารสนเทศ
                        </span>
                    </div>
                    <div class="flex mb-4 ">
                        <span class="flex  py-2 space-x-2s">
                            <span class="text-white">27 ตุลาคม 2023</span>
                        </span>
                        <span class="flex ml-2  py-2 border-l-2 border-gray-200 space-x-2s">
                            <span class="text-white ml-2">19:00</span>
                        </span>
                    </div>
                    <div class="flex mb-4">
                        <span class="flex  py-2  ">
                            <span class="text-white ">โรงภาพยนตร์ 1 </span>
                        </span>
                        <span class="flex ml-3 pl-3 py-2 border-l-2 border-gray-200 space-x-2s text-white">
                            <span class="text-white ml-3">
                                <p class="text-white">ENG</p>
                            </span>
                            <span class="flex ml-3 pl-3   border-l-2 border-gray-200 space-x-2s">
                                <span class="text-gray-600 ml-2 inline-block">
                                    <p class="text-white">THAI</p>
                                </span>
                            </span>
                    </div>
                </div>
  ...
  <!--Seat-->
  <div class="grid place-items-center bg-[#03111f] text-[#fff] mx-auto w-full min-h-fit pt-4  pb-4 sm:mt-16 lg:mt-0">
    <div class="w-[70%] max-w-[900px]">
      <section>
        <div class="flex items-center mt-3 justify-around">
          <div class="border place-item-center border-1 p-4">
  ...
  <div class="grid grid-cols-4 place-items-center mx-auto w-full bg-[#eee] pb-32">
    <div class="w-[70%] max-w-[900px] col-span-3 select-l">
      <div class="seats">
        <div class="flex flex-col gap-y-8">
          <div class="flex flex-col items-center gap-y-4">
            <img class="drop-shadow-xl"
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/GD%26T_Profileofaline.svg/512px-GD%26T_Profileofaline.svg.png"
              alt="">
            <div class="font-semibold text-center jo">จอภาพ</div>
          </div>
          <div class="grid grid-cols-12 place-items-center gap-x-2 mt-24">
            <!-- E -->
            <div class="row-id">
              E
            </div>
    ...
    <div class="">
      <form action="payment.php" method="post">
        <div
          class="block rounded-lg bg-gradient-to-b from-[#05173c] shadow-lg dark:bg-neutral-700 text-center max-w-[260px] mt-16">
          <!-- Card image -->
          <a href="">
          ...
          <div class="p-6">
            ...
            <!-- Title -->
            <h5 class="mb-2 text-xl font-bold tracking-wide text-neutral-800 dark:text-neutral-50 text-[#fff]">
              ออพเพนไฮเมอร์
            </h5>
            ...
            <p class="mt-8 text-base text-neutral-500 dark:text-neutral-300">
              โรงภาพยนตร์ 1
            </p>

            <div class="border place-item-center border-1 p-4">
              <div class="text-center text-[#3a67a1]">
                <div class="div">
                  <p>Selected Seat IDs: <span id="selectedSeat" name="selectedSeat"></span></p>
                  <p>Total Price: <span id="totalPrice" name="totalPrice">0</span> Baht</p>
                  <p style="display: none;" name="email"></p>
                </div>
                <div class="div">
                </div>
              </div>
        ...
        <div class="relative z-10 pt-20 lg:pt-24">
            <div class="container mx-auto">
                <div class="-mx-4 flex flex-wrap">
                    <div class="w-full px-4 md:w-1/2 lg:w-5/12 xl:w-4/12">
                        <div class="mb-16 max-w-[310px]">
                            <a href="index.html" class="mb-8 inline-block">
                                <img src="icon.svg" alt="logo" width="50px" height="50px">
                            </a>
                    ...
                    <div class="w-full px-4 ml-90 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-2/12">
                        <div class="mb-16">
                            ...
                            <ul class="space-y-3">
                                <li>
                                    <a href="javascript:void(0)"
                                        class="hover:underline text-base font-medium text-[#cacbcf] transition-all hover:text-white">
                                        Home
                                    </a>
                                </li>
                                <li>
            ...
            <div>
                <span class="absolute left-0 bottom-0 -z-10">
                    <svg width="138" height="220" viewBox="0 0 138 220" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <ellipse cx="-2.5" cy="140.5" rx="140.5" ry="140.5" transform="rotate(180 -2.5 140.5)"
                            fill="url(#paint0_linear_2089_516)"></ellipse>
                        <defs>
                            <linearGradient id="paint0_linear_2089_516" x1="-2.5" y1="-1.52588e-05" x2="-2.5" y2="281"
                ...
                <span class="absolute top-0 right-0 -z-10">
                    <svg width="98" height="94" viewBox="0 0 98 94" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <ellipse cx="98.5" cy="-4.5" rx="98.5" ry="98.5" transform="rotate(90 98.5 -4.5)"
                            fill="url(#paint0_linear_2089_517)"></ellipse>
                        <defs>
                            <linearGradient id="paint0_linear_2089_517" x1="98.5" y1="-103" x2="98.5" y2="94"
                                gradientUnits="userSpaceOnUse">
                                <stop stop-color="white" stop-opacity="0.22"></stop>
                                <stop offset="1" stop-color="white" stop-opacity="0"></stop>
                            </linearGradient>
