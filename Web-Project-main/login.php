        ...
        <div class="mt-12">
          ...
          <form action="" method="post" id="login">
            ...
            if ($_SERVER["REQUEST_METHOD"] === "POST") {
              ...
              $sql = "SELECT email, password, type FROM user WHERE email = '$email'";
              ...
              if (mysqli_num_rows($result) == 0) {
                echo ('There is no user record corresponding to this identifier. The user may have been deleted.');
                ...
                echo ('The password is invalid or the user does not have a password.');
            ...
            <div class="mt-10">
              <button class="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                            ...
                            shadow-lg" type="button" id="submit" onclick="submission()" disabled>
                Log In
              </button>
            </div>
          </form>
          <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
            ยังไม่เป็นสมาชิกกับ Cinentica ? <a href="signup.php"
              class="cursor-pointer text-indigo-600 hover:text-indigo-800">สมัครสมาชิก</a>
          </div>
        </div>
      </div>
    </div>
